        ...
        for (int col = mat_args->start; col < mat_args->end; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 32; qj++) {
                    // TODO: decode a packed byte into two int8 in the range of (-8, 7)
                    uint8_t packed_int4_0_0 = w0_int4[qj];
                    uint8_t packed_int4_1_0 = w1_int4[qj];
                    uint8_t packed_int4_2_0 = w2_int4[qj];
                    uint8_t packed_int4_3_0 = w3_int4[qj];
                    signed char w0_de_0 = (packed_int4_0_0 & 0x0F) - 8;
                    signed char w0_de_16 = (packed_int4_0_0 >> 4) - 8;
                    signed char w1_de_0 = (packed_int4_1_0 & 0x0F) - 8;
                    signed char w1_de_16 = (packed_int4_1_0 >> 4) - 8;
                    signed char w2_de_0 = (packed_int4_2_0 & 0x0F) - 8;
                    signed char w2_de_16 = (packed_int4_2_0 >> 4) - 8;
                    signed char w3_de_0 = (packed_int4_3_0 & 0x0F) - 8;
                    signed char w3_de_16 = (packed_int4_3_0 >> 4) - 8;
                    // TODO: int8 multiply and accumulate operation
...
void MatmulOperator::mat_mul_multithreading_loop_unrolling(struct matmul_params *params) {
    ...
    for(int i = 0; i < num_thread; i++){
        ...
        threads_args[i].end = MIN(((i + 1) * n) / num_thread, n);
